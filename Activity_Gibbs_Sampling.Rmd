...
# This plot updates our prior based on our data to form our posterior

```{r}
plot_beta_binomial(3,1,10,2)
```
...
8. Ucomment the code to create a *trace plot* showing the behavior of the samples over the $N$ iterations.Describe what these trace plots tell us.
