...
>>>>>>> 167c927494a1511377d92f98716590aeb88fbdd1
```

As you can see in Figure 1, when observing the distribution of the sampled $\pi$ values we approximate the target Beta(11,3) posterior model of $\pi$. The target pdf superimposed to our simulated model. Excellent! Know you know how to approximate a posterior using Markov Chains [@Alicia]
...
8. Ucomment the code to create a *trace plot* showing the behavior of the samples over the $N$ iterations.Describe what these trace plots tell us, do you think this is a good chain? 
